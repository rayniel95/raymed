import {
  ...
  describe("Patient", function () {
    ...
    async function deployPatientFixture() {
        ...
        return { patient, doctor, admin, deployer, superUser, adminUser, doctorUser };
      }
    
      async function mintFirstPatient() {
          // Contracts are deployed using the first signer/account by default
          const {doctor, admin, deployer, superUser, adminUser, doctorUser} = await loadFixture(deployPatientFixture);
